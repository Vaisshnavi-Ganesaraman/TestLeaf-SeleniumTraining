...
public class Myntra {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
		System.out.println(
				"Count of Jackets items : " + driver.findElement(By.xpath("//span[@class='title-count']")).getText());
		...
		if (count == Integer.parseInt(driver.findElement(By.xpath("//span[@class='title-count']")).getText()
		...
		Thread.sleep(3000);
		System.out.println("Price of first listed product :"
		...
		Thread.sleep(3000);
		File showImg = driver.findElement(By.xpath("//div[contains(@class,'image-grid-container')]"))
