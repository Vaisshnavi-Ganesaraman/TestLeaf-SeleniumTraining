...
public class Snapdeal {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
		System.out.println("Count of Sport Shoes : "
				+ driver.findElement(By.xpath("//div[text()='Sports Shoes']/following-sibling::div")).getText());
		...
		builder.moveToElement(driver.findElement(By.xpath("//div[@class='clearfix row-disc']"))).perform();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//div[@class='center quick-view-bar  btn btn-theme-secondary  ']")).click();

		driver.switchTo().activeElement();
		System.out.println(
				"Price of the selected shoe : " + driver.findElement(By.xpath("//span[@class='payBlkBig']")).getText());
		System.out.println("Discount received for the selected shoe : "
				+ driver.findElement(By.xpath("//span[@class='percent-desc ']")).getText());

		File showImg = driver.findElement(By.xpath("(//div[@class='bx-viewport'])[2]"))
